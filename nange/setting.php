				...
				<table width="90%"  align="center" cellpadding="5" cellspacing="1" class="tablecss" >
					...
					<tr>
					  ...
					  <td width="690" valign="middle">
					  	...
					  	<span class="gray tips">如：唯美女生</span>
					  </td>
					</tr>
					<tr>
					    ...
					    <td width="690" valign="middle">
					      ...
					      <span class="gray tips">网站域名，如 http://v.vmgirls.com </span>
					    </td>
					</tr>
					<tr>
					...
					<tr>
					    ...
					    <td valign="top">请将解析接口分别填入下列空中<font color="red">（第一条是默认调用接口）</font><div class="cl5"></div>
							...
							<input type="text" name="aik[jiekou10name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou10name']?>" size=20" ><input type="text" name="aik[jiekou10]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou10']?>" size="80" >
							<br/><input type="text" name="aik[jiekou11name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou11name']?>" size=20" ><input type="text" name="aik[jiekou11]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou11']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou12name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou12name']?>" size=20" ><input type="text" name="aik[jiekou12]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou12']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou13name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou13name']?>" size=20" ><input type="text" name="aik[jiekou13]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou13']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou14name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou14name']?>" size=20" ><input type="text" name="aik[jiekou14]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou14']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou15name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou15name']?>" size=20" ><input type="text" name="aik[jiekou15]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou15']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou16name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou16name']?>" size=20" ><input type="text" name="aik[jiekou16]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou16']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou17name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou17name']?>" size=20" ><input type="text" name="aik[jiekou17]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou17']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou18name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou18name']?>" size=20" ><input type="text" name="aik[jiekou18]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou18']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou19name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou19name']?>" size=20" ><input type="text" name="aik[jiekou19]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou19']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou20name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou20name']?>" size=20" ><input type="text" name="aik[jiekou20]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou20']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou21name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou21name']?>" size=20" ><input type="text" name="aik[jiekou21]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou21']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou22name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou22name']?>" size=20" ><input type="text" name="aik[jiekou22]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou22']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou23name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou23name']?>" size=20" ><input type="text" name="aik[jiekou23]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou23']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou24name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou24name']?>" size=20" ><input type="text" name="aik[jiekou24]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou24']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou25name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou25name']?>" size=20" ><input type="text" name="aik[jiekou25]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou25']?>" size="80" >
							<br/><input type="text" name="aik[jiekou26name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou26name']?>" size=20" ><input type="text" name="aik[jiekou26]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou26']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou27name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou27name']?>" size=20" ><input type="text" name="aik[jiekou27]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou27']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou28name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou28name']?>" size=20" ><input type="text" name="aik[jiekou28]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou28']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou29name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou29name']?>" size=20" ><input type="text" name="aik[jiekou29]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou29']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou30name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou30name']?>" size=20" ><input type="text" name="aik[jiekou30]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou30']?>" size="80" >
<br/>
							<input type="text" name="aik[jiekou31name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou31name']?>" size=20" ><input type="text" name="aik[jiekou31]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou31']?>" size="80" >
<br/><br/>
					    </td>
					</tr>
					<tr>
